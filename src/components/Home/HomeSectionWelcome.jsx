const HomeSectionWelcome = () => {
    return (
        <article className="home_section_welcome">
            <h3 className="home_section_welcome_title">Bienvenue à notre mariage !</h3>
            ...
            <p className="home_section_welcome_content">
                La cérémonie débutera à 15:00 suivie d'un cocktail et d'un dîner. 
                Nous vous attendons avec impatience pour partager cette journée 
                mémorable avec nous.
            </p>
            <p className="home_section_welcome_content">
